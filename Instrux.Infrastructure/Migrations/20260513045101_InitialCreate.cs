        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ColorHex = table.Column<string>(type: "nvarchar(9)", maxLength: 9, nullable: false, defaultValue: "#4F46E5"),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Assessments_SchoolClasses_ClassId",
                        column: x => x.ClassId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ContentItems_SchoolClasses_ClassId",
                        column: x => x.ClassId,
                        principalTable: "SchoolClasses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AttendanceRecords_ClassId_StudentId_Date",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Students_StudentIdentifier",
                table: "Students",
                column: "StudentIdentifier",
                unique: true,
                filter: "[StudentIdentifier] IS NOT NULL");
